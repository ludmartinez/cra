...
class CreateAlumnosTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('alumnos', function (Blueprint $table) {
            ...
            $table->boolean('solvencia')->default(true);
        ...
        DB::connection()->getPdo()->exec(
            "
            CREATE TRIGGER alumnos_BI BEFORE INSERT ON alumnos FOR EACH ROW
            BEGIN
                ...
                INSERT INTO users(usuario, email, password, tipo, created_at, updated_at) values(lower(NEW.carnet), email, pass, 'Alumno', NEW.created_at, NEW.updated_at);
