...
<section class="container mb-2">
    <h3 class="text-center text-md-left">Agregar Admin</h3>
    <hr>
    <div class="card p-2">
        <form id="formAdmin" enctype="multipart/form-data" novalidate>
            @csrf
            <div class="form-row">
                <div class="col-12">
                ...
                <div class="col-12 col-sm col-md col-lg">
                    <div class="form-row">
                        ...
                        <div class="col-12 col-md-4 mb-3">
                            ...
                            <input type="number" id="dui" name="dui" class="form-control" placeholder="dui">
                    ...
                    {{-- nombres --}}
                    <div class="form-row">
                        <div class="col-12 col-sm col-md-4 mb-3">
                    ...
                    {{-- apellidos --}}
                    <div class="form-row">
                        <div class="col-12 col-sm col-md mb-3">
    ...
    $('button[type="submit"]').click(function (event) {
        ...
        $.ajax({
            ...
            error: function (msj) {
                console.log(msj);
                $('#loading').addClass('d-none');
                if (msj.responseJSON.errors.dui != undefined) {
                ...
                if (msj.responseJSON.errors.tipo != undefined) {
