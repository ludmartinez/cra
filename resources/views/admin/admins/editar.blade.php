...
<section class="container my-2">
    <h3 class="text-center text-sm-left">Editar Admin <small><a href="{{ route('admins.show', $admin) }}">{{
                $admin->carnet }}</a></small></h3>
    <hr>
    <form class="accordion" id="formAdmin">
        <div class="card">
            ...
            <div id="collapsePerfil" class="collapse show" aria-labelledby="headingPerfil" data-parent="#formAdmin">
                <div class="card-body">
                    @csrf @method('PUT')
                    <div class="form-row">
                        <!--seccion foto-->
                        <div class="col-12 col-md-4 col-lg-3 mb-3">
                            ...
                            <div class="form-row card py-2 bg-light">
                                <div class="col-12 mb-1 text-center" id="contenedor-foto">
                                    <img src="{{ $admin->foto }}" id="foto-preview" alt="Foto" class="img-fluid"
                                ...
                                <div class="col-12 col-md-4 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="primerNombre" name="primerNombre"
                                            placeholder="Primer Nombre" required value="{{ $admin->primerNombre }}"
                                            disabled>
                                ...
                                <div class="col-12 col-md-4 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="segundoNombre" name="segundoNombre"
                                            placeholder="Segundo Nombre" value="{{ $admin->segundoNombre }}" disabled>
                                        <div class="input-group-prepend">
                                ...
                                <div class="col-12 col-md-4 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="tercerNombre" name="tercerNombre"
                                            placeholder="Tercer Nombre" value="{{ $admin->tercerNombre }}" disabled>
                                        <div class="input-group-prepend">
                                ...
                                <div class="col-md mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="apellidoPaterno" name="apellidoPaterno"
                                            placeholder="Apellido Paterno" required value="{{ $admin->apellidoPaterno }}"
                                            disabled>
                                        <div class="input-group-prepend">
                                ...
                                <div class="col-md mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="apellidoMaterno" name="apellidoMaterno"
                                            placeholder="Apellido Materno" required value="{{ $admin->apellidoMaterno }}"
                                            disabled>
                                        <div class="input-group-prepend">
                                ...
                                <div class="col-12 col-md mb-3">
                                    ...
                                    <div class="input-group">
                                        <select name="sexo" id="sexo" class="form-control" disabled>
                                            ...
                                            <option value="Femenino" @if ($admin->sexo === 'Femenino') selected
                                                @endif>Femenino</option>
                                            <option value="Masculino" @if ($admin->sexo === 'Masculino') selected
                                ...
                                <div class="col-12 col-md mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="date" id="fechaNacimiento" name="fechaNacimiento" class="form-control"
                                            value="{{ $admin->fechaNacimiento }}" disabled>
                                        <div class="input-group-prepend">
        ...
        <div class="card">
            ...
            <div id="collapseInstitucional" class="collapse" aria-labelledby="headingInstitucional" data-parent="#formAdmin">
                <div class="card-body">
                    <div class="form-row">
                        <!-- dui -->
                        <div class="col-12 col-md-4 mb-3">
                            ...
                            <div class="input-group">
                                <input type="number" id="dui" name="dui" class="form-control" placeholder="dui" value="{{ $admin->dui }}"
                                    disabled>
                                <div class="input-group-prepend">
                                    <button class="btn btn-info" type="button" onclick="editar('dui')"><i class="fas fa-pen"></i></button>
                                </div>
                                <div id="invalid_dui" class="invalid-feedback">
                                    ¡Incorrecto!
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md mb-3">
                            ...
                            <div class="input-group">
                                <input type="date" id="fechaIngreso" name="fechaIngreso" class="form-control" value="{{ $admin->fechaIngreso }}"
                                    disabled>
                                <div class="input-group-prepend">
                        ...
                        <div class="col-12 col-md">
                            ...
                            <div class="input-group">
                                <select id="estado" name="estado" class="form-control" disabled>
                                    <option value="1" @if ($admin->estado == true)
                                        selected
                                        @endif>Activo</option>
                                    <option value="0" @if ($admin->estado == false)
                                        selected
                        ...
                        <div class="col-12 col-md">
                            ...
                            <div class="input-group">
                                <select id="tipo" name="tipo" class="form-control" disabled>
                                    <option value="0" @if ($admin->superUsuario == true)
                                        selected
                                        @endif>Normal</option>
                                    <option value="1" @if ($admin->superUsuario == false)
                                        selected
                                        @endif>Master</option>
                                </select>
                                <div class="input-group-prepend">
                                    <button class="btn btn-info" type="button" onclick="editar('tipo')"><i class="fas fa-pen"></i></button>
                                </div>
                                <div id="invalid_tipo" class="invalid-feedback">
                                    ¡Incorrecto!
                                </div>
                            </div>
                        </div>
        ...
        <div class="card">
            ...
            <div id="collapseAcceso" class="collapse" aria-labelledby="headingAcceso" data-parent="#formAdmin">
                <div class="card-body">
                    <div class="form-row">
                        <div class="col-12 col-md">
                            <label for="usuario">Usuario</label>
                            <div class="input-group">
                                <input type="text" id="usuario" name="usuario" class="form-control" value="{{ $admin->user->usuario }}"
                                    disabled>
                                <div class="input-group-prepend">
                        ...
                        <div class="col-12 col-md">
                            ...
                            <div class="input-group">
                                <input type="text" id="email" name="email" class="form-control" value="{{ $admin->user->email }}"
                                    disabled>
                                <div class="input-group-prepend">
                        ...
                        <div class="col-12 col-md">
                            ...
                            <div class="input-group">
                                <input type="text" id="password" name="password" class="form-control" value="{{ $admin->user->password }}"
                                    disabled>
                                <div class="input-group-prepend">
...
<script>
    ...
    $('a[type="submit"]').click(function (event) {
        ...
        var route = "{{ route('admins.update', $admin) }}";
        var datos = new FormData();
        datos.append('carnet', '{{ $admin->carnet }}');
        datos.append('_method', $('input[name="_method"]').val());
        if (!$('#dui').attr('disabled')) {
            datos.append('dui', $('#dui').val());
        }
        ...
        $.ajax({
            ...
            data: datos,
            beforeSend: function () {
                $('form#formAdmin input').removeClass('is-invalid');
                $('form#formAdmin select').removeClass('is-invalid');
            ...
            success: function (response) {
                ...
                // console.log(response.admin.carnet);
                $('form#formAdmin input').attr('disabled', true);
                $('form#formAdmin select').attr('disabled', true);
            ...
            error: function (msj) {
                console.log(msj);
                $('#loading').addClass('d-none');
                if ((msj.responseJSON.errors.dui != undefined) && (!$('#dui').attr('disabled'))) {
                    $('#dui').addClass('is-invalid');
                    $('#invalid_dui').html(msj.responseJSON.errors.dui);
                ...
                if (msj.responseJSON.errors.tipo != undefined && !$('#tipo').attr(
                        'disabled')) {
                    $('#tipo').addClass('is-invalid');
                    $('#invalid_tipo').html(msj.responseJSON.errors.tipo);
                    $('#collapseAcceso').addClass('show');
                } else {
