...
<div class="row bg-secondary text-white">>
    <div class="col-12">
        <h3 class="text-center mx-auto mb-0">{{ $alumno->fullName() }}</h3>
    </div>
    <div class="col text-center pb-2">
        @if ( $alumno->estado == true )
        <span class="badge badge-success p-1">Activo</span> @else
        <span class="badge badge-danger p-1">Inactivo</span> @endif @if ( $alumno->solvencia == true )
        <span class="badge badge-info p-1">Solvente</span> @else
        <span class="badge badge-warning p-1">Insolvente</span> @endif
    </div>
</div>
            ...
            <div class="card-body">
                <div class="form-row">
                    <div class="col-12 col-md-4 col-lg-3 col-xl-3 text-center">
                        @if ($alumno->foto!=null)
                        <img src="{{ $alumno->foto }}" alt="Foto de Alumno" class="img-fluid rounded" style="max-height:17em">@else
                    ...
                    <div class="col">
                        ...
                        <div class="form-row">
                            <div class="col-12 col-md-4 mt-2">
                                ...
                                <input type="text" class="form-control" id="txt_primerNombre" value="{{ $alumno->primerNombre }}" readonly>
                            </div>
                            <div class="col-12 col-md-4 mt-2">
                                <label for="txt_segundoNombre">Segundo Nombre</label>
                                <input type="text" class="form-control" id="txt_segundoNombre" value="{{ $alumno->segundoNombre }}" readonly>
                            </div>
                            <div class="col-12 col-md-4 mt-2">
                                <label for="txt_tercerNombre">Tercer Nombre</label>
                                <input type="text" class="form-control" id="txt_tercerNombre" value="{{ $alumno->tercerNombre }}" readonly>
                            </div>
                            <div class="col-12 col-md-6 mt-2">
                                <label for="txt_apellidoPaterno">Apellido Paterno</label>
                                <input type="text" class="form-control" id="txt_apellidoPaterno" value="{{ $alumno->apellidoPaterno }}" readonly>
                            </div>
                            <div class="col-12 col-md-6 mt-2">
                                <label for="txt_apellidoMaterno">Apellido Materno</label>
                                <input type="text" class="form-control" id="txt_apellidoMaterno" value="{{ $alumno->apellidoMaterno }}" readonly>
                            </div>
                            <div class="col-12 col-md mt-2">
                                <label for="txt_sexo">Sexo</label>
                                <input type="text" class="form-control" id="txt_sexo" value="{{ $alumno->sexo }}" readonly>
                            </div>
                            <div class="col-12 col-md mt-2">
                                <label for="dtp_fechaNacimiento">Fecha de Nacimiento</label>
                                <input type="date" class="form-control" id="dtp_fechaNacimiento" value="{{ $alumno->fechaNacimiento }}" readonly>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12 col-sm">
                        ...
                        <div class="form-row">
                            <div class="col-12 col-md mt-2">
                                ...
                                <input type="text" class="form-control" name="usuario" id="txt_user" value="{{ $user->usuario }}" readonly>
                            </div>
                            <div class="col-12 col-md mt-2">
                            ...
                            <div class="col-12 col-md-12 mt-2">
                                ...
                                <input type="email" class="form-control" name="email" id="txt_email" value="{{ $user->email }}" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        ...
                        <div class="form-row">
                            <div class="col-12 col-md mt-2">
                                ...
                                <input type="text" class="form-control" id="txt_carnet" value="{{ $alumno->carnet }}" readonly>
                            </div>
                            <div class="col-12 col-md mt-2">
                                <label for="txt_nie">NIE</label>
                                <input type="text" class="form-control" id="txt_nie" value="{{ $alumno->nie }}" readonly>
                            </div>
                            <div class="col-12 col-md mt-2">
                                <label for="dtp_fechaIngreso">Fecha de Ingreso</label>
                                <input type="date" class="form-control" id="dtp_fechaIngreso" value="{{ $alumno->fechaIngreso }}" readonly>
                            </div>
                        </div>
                    </div>
                </div>
