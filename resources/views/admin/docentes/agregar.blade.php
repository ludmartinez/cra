...
<section class="container mb-2">
    <h3 class="text-center text-md-left">Agregar Docente</h3>
    <hr>
    <div class="card p-2">
        <form id="formDocente" enctype="multipart/form-data" novalidate>
            @csrf
            <div class="form-row">
                <div class="col-12">
...
<script>
    ...
    $('button[type="submit"]').click(function (event) {
        ...
        var route = "{{ route('docentes.store') }}";
        ...
        $.ajax({
            ...
            success: function (response) {
                $('#formDocente').addClass('was-validated');
