...
<section class="container my-2">
    <h3 class="text-center text-sm-left">Editar Docente <small><a href="{{ route('docentes.show', $docente) }}">{{
                $docente->carnet }}</a></small></h3>
    <hr>
    <form class="accordion" id="formDocente">
        <div class="card">
            ...
            <div id="collapsePerfil" class="collapse show" aria-labelledby="headingPerfil" data-parent="#formDocente">
                <div class="card-body">
                    @csrf @method('PUT')
                    <div class="form-row">
                        <!--seccion foto-->
                        <div class="col-12 col-md-4 col-lg-3 mb-3">
                            ...
                            <div class="form-row card py-2 bg-light">
                                <div class="col-12 mb-1 text-center" id="contenedor-foto">
                                    <img src="{{ $docente->foto }}" id="foto-preview" alt="Foto" class="img-fluid"
                                ...
                                <div class="col-12 col-md-4 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="primerNombre" name="primerNombre"
                                            placeholder="Primer Nombre" required value="{{ $docente->primerNombre }}"
                                            disabled>
                                ...
                                <div class="col-12 col-md-4 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="segundoNombre" name="segundoNombre"
                                            placeholder="Segundo Nombre" value="{{ $docente->segundoNombre }}" disabled>
                                        <div class="input-group-prepend">
                                ...
                                <div class="col-12 col-md-4 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="tercerNombre" name="tercerNombre"
                                            placeholder="Tercer Nombre" value="{{ $docente->tercerNombre }}" disabled>
                                        <div class="input-group-prepend">
                                ...
                                <div class="col-md mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="apellidoPaterno" name="apellidoPaterno"
                                            placeholder="Apellido Paterno" required value="{{ $docente->apellidoPaterno }}"
                                            disabled>
                                        <div class="input-group-prepend">
                                ...
                                <div class="col-md mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="apellidoMaterno" name="apellidoMaterno"
                                            placeholder="Apellido Materno" required value="{{ $docente->apellidoMaterno }}"
                                            disabled>
                                        <div class="input-group-prepend">
                                ...
                                <div class="col-12 col-md mb-3">
                                    ...
                                    <div class="input-group">
                                        <select name="sexo" id="sexo" class="form-control" disabled>
                                            ...
                                            <option value="Femenino" @if ($docente->sexo === 'Femenino') selected
                                                @endif>Femenino</option>
                                            <option value="Masculino" @if ($docente->sexo === 'Masculino') selected
                                ...
                                <div class="col-12 col-md mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="date" id="fechaNacimiento" name="fechaNacimiento" class="form-control"
                                            value="{{ $docente->fechaNacimiento }}" disabled>
                                        <div class="input-group-prepend">
        ...
        <div class="card">
            ...
            <div id="collapseInstitucional" class="collapse" aria-labelledby="headingInstitucional" data-parent="#formDocente">
                <div class="card-body">
                    <div class="form-row">
                        <!-- dui -->
                        <div class="col-12 col-md-4 mb-3">
                            ...
                            <div class="input-group">
                                <input type="number" id="dui" name="dui" class="form-control" placeholder="dui" value="{{ $docente->dui }}"
                                    disabled>
                                <div class="input-group-prepend">
                        ...
                        <div class="col-12 col-md mb-3">
                            ...
                            <div class="input-group">
                                <input type="date" id="fechaIngreso" name="fechaIngreso" class="form-control" value="{{ $docente->fechaIngreso }}"
                                    disabled>
                                <div class="input-group-prepend">
                        ...
                        <div class="col-12 col-md">
                            ...
                            <div class="input-group">
                                <select id="estado" name="estado" class="form-control" disabled>
                                    <option value="1" @if ($docente->estado == true)
                                        selected
                                        @endif>Activo</option>
                                    <option value="0" @if ($docente->estado == false)
                                        selected
        ...
        <div class="card">
            ...
            <div id="collapseAcceso" class="collapse" aria-labelledby="headingAcceso" data-parent="#formDocente">
                <div class="card-body">
                    <div class="form-row">
                        <div class="col-12 col-md">
                            <label for="usuario">Usuario</label>
                            <div class="input-group">
                                <input type="text" id="usuario" name="usuario" class="form-control" value="{{ $docente->user->usuario }}"
                                    disabled>
                                <div class="input-group-prepend">
                        ...
                        <div class="col-12 col-md">
                            ...
                            <div class="input-group">
                                <input type="text" id="email" name="email" class="form-control" value="{{ $docente->user->email }}"
                                    disabled>
                                <div class="input-group-prepend">
                        ...
                        <div class="col-12 col-md">
                            ...
                            <div class="input-group">
                                <input type="text" id="password" name="password" class="form-control" value="{{ $docente->user->password }}"
                                    disabled>
                                <div class="input-group-prepend">
...
<script>
    ...
    $('a[type="submit"]').click(function (event) {
        ...
        var route = "{{ route('docentes.update', $docente) }}";
        var datos = new FormData();
        datos.append('carnet', '{{ $docente->carnet }}');
        ...
        $.ajax({
            ...
            data: datos,
            beforeSend: function () {
                $('form#formDocente input').removeClass('is-invalid');
                $('form#formDocente select').removeClass('is-invalid');
                // $('#formDocente').removeClass('was-validated');
                $('#loading').removeClass('d-none');
            },
            success: function (response) {
                $('#loading').addClass('d-none');
                console.log(response);
                // console.log(response.docente.carnet);
                $('form#formDocente input').attr('disabled', true);
                $('form#formDocente select').attr('disabled', true);
